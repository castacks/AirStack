...
def launch_setup(context, *args, **kwargs):
    ...
    if( camera_model_val=='zed' or
        ...
        zed_wrapper_component = ComposableNode(
            ...
            remappings=[('/robot_1/sensors/front_stereo/left/image_rect_color', '/robot_1/sensors/front_stereo/left/image'),
                        ('/robot_1/sensors/front_stereo/right/image_rect_color', '/robot_1/sensors/front_stereo/right/image'),
                        ('/robot_1/sensors/front_stereo/disparity/disparity_image', '/robot_1/front_stereo/disparity')]
        )
