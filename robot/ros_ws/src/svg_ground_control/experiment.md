...
| `/policy_commander/obs`, `/action`, `/waypoint`, `/goal` | out | `std_msgs/Float32MultiArray` | policy telemetry; `goal` is always published and is the current ball-goal XY reference |
