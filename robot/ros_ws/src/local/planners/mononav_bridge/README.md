...
The bridge subscribes to the simulated left RGB camera, its calibration, and ground-
truth odometry. For every sampled image it looks up `map -> camera_left`, so the pose
...
- Inputs: `image`, `camera_info`, `odometry`
