...
#include "lawnmower_logic.hpp"
#include "rclcpp/rclcpp.hpp"

class LawnmowerNode : public rclcpp::Node{
    private:
    std::unique_ptr<LawnmowerPlanner> lawnmower_planner;
    ...
    void lawnmowerToggleCallback(const std_srvs::srv::Trigger::Request::SharedPtr request,
    ...
    // ROS services
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr srv_lawnmower_toggle;
    // ROS timers
