...
public:
    ...
    {
        input_topic_ = this->declare_parameter<std::string>("input_topic", "/registered_scan");
        output_topic_ = this->declare_parameter<std::string>("output_topic", "/registered_scan_fixed");
        fixed_frame_ = this->declare_parameter<std::string>("fixed_frame", "superodom_map");
