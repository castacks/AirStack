...
namespace collision_checker_ns
{
    ...
    bool CollisionChecker::collisionCheckRayLoose(const ViewPoint &p_start, const ViewPoint &p_end, openvdb::Vec3d &hit_point)
    {
    ...
    bool CollisionChecker::collisionCheckInFreeSpaceShrink(const ViewPoint &p)
    {
        ...
        bool is_in_collision = !VDBUtil::collCheckPointInPartialFreeSpace(grid_map_, query_pt,
                                                                    kBboxLength_ - kVoxSize_, kBboxBreadth_ - kVoxSize_, kBboxHeight_ - kVoxSize_,
                                                                    kL_occ_, kUnknown_fraction_thresh_, kOccupied_fraction_thresh_);
