...
namespace collision_checker_ns
{
    ...
    public:
        ...
        bool collisionCheckRayLoose(const ViewPoint &p_start, const ViewPoint &p_end, openvdb::Vec3d& hit_point);
        ...
        bool collisionCheckInFreeSpaceShrink(const ViewPoint &p);
