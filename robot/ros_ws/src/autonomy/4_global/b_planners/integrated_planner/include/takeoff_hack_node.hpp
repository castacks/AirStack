...
private:
    ...
    rclcpp::Service<airstack_msgs::srv::TrajectoryMode>::SharedPtr traj_mode_server_;
    rclcpp::Client<mavros_msgs::srv::CommandTOL>::SharedPtr takeoff_client_;

    void set_trajectory_mode(const std::shared_ptr<airstack_msgs::srv::TrajectoryMode::Request> request,
