...
## Ascent OmniGraph Node (Deprecated)

The Ascent OmniGraph node is **deprecated** — PX4 via the [Pegasus extension](pegasus_scene_setup.md) is the supported vehicle-dynamics path.
