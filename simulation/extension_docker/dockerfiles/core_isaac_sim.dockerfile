...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    gstreamer1.0-plugins-ugly gstreamer1.0-libav libeigen3-dev libgstreamer-plugins-base1.0-dev libimage-exiftool-perl \
    libopencv-dev libxml2-utils pkg-config protobuf-compiler lsb-release libasio-dev ros-humble-mavros \
    && rm -rf /var/lib/apt/lists/*
