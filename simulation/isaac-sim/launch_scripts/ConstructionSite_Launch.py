...
# --------------------- CONFIGURATION ---------------------
ENV_URL = os.path.expanduser("~/AirStack/scenes/ConstructionSite/ConstructionSite_Export.usd")

DRONE_X  = float(os.environ.get('DRONE_X')  or '13.7')
DRONE_Y  = float(os.environ.get('DRONE_Y')  or '-1.2')
