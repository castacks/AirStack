#!/usr/bin/env python
"""
Preview launcher for the graph-based suburb (scene_gen/layout/suburb_net.py).

Deliberately a near-copy of scene_launch_script.py — same base
...
Open the Kit Script Editor (Window -> Script Editor) and run:
    ...
    import scene_generator, suburb_scene, scene_prep
    from layout import suburb_net
    from detail import suburb_parcel
...
def _remove_env_clutter(stage):
    ...
    survives. Same reasoning as scene_launch_script.
    """
    n = 0
