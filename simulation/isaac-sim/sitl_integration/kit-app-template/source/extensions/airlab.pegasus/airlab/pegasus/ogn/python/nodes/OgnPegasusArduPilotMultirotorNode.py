...
class OgnPegasusArduPilotMultirotorNodeState:
    def __init__(self):
        self.node_initialized: bool = False


class OgnPegasusArduPilotMultirotorNode:
    """ArduPilot-specific Pegasus Multirotor OmniGraph node"""
    
    @staticmethod
    def internal_state():
        return OgnPegasusArduPilotMultirotorNodeState()
    ...
    def initialize(context, node: og.Node):
        ...
        return OgnPegasusMultirotorBaseNode.initialize(context, node, OgnPegasusArduPilotMultirotorNodeDatabase)
    ...
    def compute(db) -> bool:
        ...
        try:
            ...
            return OgnPegasusMultirotorBaseNode.compute_base(
                ...
                OgnPegasusArduPilotMultirotorNode.create_ardupilot_backend_config
            )
