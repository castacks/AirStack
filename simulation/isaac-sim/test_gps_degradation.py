...
def test_dop_and_state() -> None:
    signals = [
        SatelliteSignal(s.elevation_deg, s.azimuth_deg, True, 40.0)
...
def test_nlos_classification() -> None:
    class Physx:
        def __init__(self):
            self.calls = 0
    ...
    assert physx.calls == 1


if __name__ == "__main__":
    test_tle_constellation()
    test_dop_and_state()
    test_nlos_classification()
