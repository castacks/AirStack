...
| L2 | Canonical frozen scene; Frontier and VLFM baselines | CoNavGPT2 active; Lawnmower rerun + RayFronts | `urban_fire_remaining_8robot_optimized_pod58/2026-09-07_06-10-59` |
...
| 8c | `airstack-mission-1gpu-58` | Fire/Urban L1 Lawnmower + L2 four baselines | 3/5 | <12 h | RUNNING — L1 Lawnmower, L2 Frontier, and L2 VLFM passed/uploaded/NAS-verified at team RTFs **0.17612**, **0.19247**, and **0.20916**. L2 Lawnmower exhausted two tooling-failure attempts and was not uploaded; it needs a focused rerun. L2 CoNavGPT2 is active. Owned renderer/model GPU 2, original sensors/full contacts, pass-only immediate uploads, auto-launcher held |
