...
| 2-GPU 5 | Hurricane Suburban L3 RAVEN replacement started at **03:20:27 UTC** on renderer GPU 0 / offboard GPU 1 | The stale Urban Fire standard runner produced 0 passes because all six attempts lacked a global mapper subscriber for the live mono-RGBD cloud; it was stopped after the repeated gate, with failed artifacts preserved and unuploaded. The replacement uses commit `27ac448d`, 2× RTX PRO 5000 Blackwell, 300 s takeoff feedback, the 8/8 advancing-odometry gate, 8×600 s result gate, and checksum-verified upload/prune. Launcher PID 61 remains T. |
