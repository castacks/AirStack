...
| 1-GPU 58 | Hurricane Urban L2 Lawnmower, started 18:03:52 UTC | **29 standard-baseline cells remain** after the accepted Frontier replacement |
...
`remaining58_hurricaneurbanl2v1_lawnmower/2026-09-07_18-03-52`.
...
**10 new accepted runs since the September 6 evening queue**: 4 on dev 191
and 6 on pod 58. Rechecked all ten NAS `iteration.json` files (`passed`)
and nonempty MCAPs on September 7. Failed attempts and short diagnostics are
excluded. Hurricane Urban L2 Lawnmower is now active on pod 58.
...
**4/4**, L3 **4/4**.
Hurricane Urban L1 is **4/4**; L2 is **1/4** and L3 remains **0/4**.
...
| 11 | pod 58 queue | Hurricane/Urban L2 × Frontier, lawnmower, VLFM, CoNavGPT2 | 1/4 | ≤12 h per launch | FRONTIER PASSED / LAWNMOWER ACTIVE — the pod 58 Frontier replacement passed all 17 steps at bottleneck/team **RTF 0.20779** under `remaining58_hurricaneurbanl2v1_frontier/2026-09-07_16-58-05`; its passed metadata and 3.78 GB MCAP were independently NAS-verified. The queue advanced only after verification and started Lawnmower at **18:03:52 UTC** under `remaining58_hurricaneurbanl2v1_lawnmower/2026-09-07_18-03-52`, runner PID 1097377. Both use the new **12/8** camera cohort, full contacts and GPU 2/2. Failed attempts never upload |
