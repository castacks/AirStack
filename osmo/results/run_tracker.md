...
| 2-GPU 5 | Hurricane Suburban L3 RAVEN replacement entered 8-robot search at **03:54:26 UTC** on renderer GPU 0 / offboard GPU 1 | Attempt 1 correctly failed the encoder gate because this stale pod lacked the offline SigLIP2 cache; it was not uploaded. After an exact cache transfer, attempt 2 passed the live CUDA encoder, 8-robot frame, PX4, perception, takeoff and advancing-odometry gates. It retains the 8×600 s result gate and checksum-verified upload/prune; a persistent callback RTF probe is running. Launcher PID 61 remains T. |
