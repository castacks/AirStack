...
| 8c | `airstack-mission-1gpu-58` | Fire/Urban L1 Lawnmower + L2 four baselines | 4/5 | 6 h 19 min | RERUN ACTIVE — L1 Lawnmower, L2 Frontier, L2 VLFM and L2 CoNavGPT2 passed/uploaded/NAS-verified at team RTFs **0.17612**, **0.19247**, **0.20916**, and **0.25566**. The focused L2 Lawnmower rerun started at **15:47:29 UTC** under `remaining58_fireurbanl2v1_lawnmower/2026-09-07_15-47-29`; runner PID 4100223, original sensors/full contacts and GPU 2/2. All eight PX4/canonical-odometry endpoints became ready at 15:57:45 UTC and the preflight steps are running. Passed results upload immediately and failed attempts do not upload |
...
| 11 | dev pod 191 / pod 58 queue | Hurricane/Urban L2 × Frontier, lawnmower, VLFM, CoNavGPT2 | 0/4 | ≤12 h | RETRY ACTIVE — Frontier started on dev 191 at **15:45:08 UTC** under `hurricane_urban_l2_frontier_dev191/2026-09-07_15-45-08`, runner PID 3286287, original optimized 32/8 sensors/full contacts/CPU physics and owned GPU pins 3/3. Attempt 1 was rejected and not uploaded after robot 1 exhausted the pre-arm state gate: MAVROS reported the vehicle truly armed in `AUTO.LOITER`, while `/robot_1/interface/is_armed` remained false. The second and final attempt started at **15:57:36 UTC**. The runner has a 6,000-second wall cap plus five-minute cleanup allowance before pod expiry. Literal NAS credentials were validated and are present; only a passed result uploads. The other three methods remain in pod 58's durable queue |
