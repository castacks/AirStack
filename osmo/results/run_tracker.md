...
| 2-GPU 3 | Fire Suburban L1 RAVEN **passed, uploaded and NAS-verified** at 15:53:19 UTC; repaired Fire Suburban L3 rerun reached takeoff at 17:53 UTC | L1 final RTF **0.0398**, 12/49 GT matched (24.5% recall), 5.66 km team path. The first L3 batch failed 7/8 takeoff twice (robot 7, then robot 5); neither attempt uploaded. Timed-out takeoffs now send a bounded cancel before retry. Current focused runner PID **4054655** passed 8/8 PX4/canonical odometry, bridge and perception gates after one bounded robot-7 bringup recovery; folder `2026-09-08_17-41-24`. Launcher PID 60 remains T |
