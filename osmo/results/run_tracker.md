...
GPU used about 20.35 GiB with Isaac and the detector active.
...
| 8c | `airstack-mission-1gpu-58` | Fire/Urban L1 Lawnmower + L2 four baselines | 0/5 | <12 h | RUNNING — L1 Lawnmower passed all eight readiness, bridge, perception and takeoff gates; persistent-callback RTF **0.18093**. Owned renderer/model GPU 2, original sensors/full contacts, pass-only immediate uploads, auto-launcher held |
