...
| 2-GPU 5 | Hurricane Suburban L3 and Tornado Suburban L2 RAVEN are **passed, uploaded, checksum-verified and locally pruned**; corrected Earthquake Suburban L1 retry began at **10:51:45 UTC** under `raven_earthquakesuburbanl1v1_raven_remaining_2gpu1/2026-09-09_10-51-45` | The 10:17 attempt reached 7/8 reported takeoffs; robot 6's original takeoff remained healthy and reached 19.86 m, but the lane's 300-wall-second feedback watchdog fired first and overlapping retries were rejected. The failed attempt was not uploaded; its 2.9 GB diagnostic bags remain local. Commit `c49be758` raises the takeoff feedback watchdog to 900 seconds in all 33 remaining RAVEN specs. Tornado L2 passed at whole-step **RTF 0.0446**, strict 10 m **0/40**, with only 51.2 m team motion. Launcher PID 61 remains T. |
...
| `airstack-mission-8robot-2gpu-5` | RAVEN lane B | RUNNING — Hurricane Suburban L3 and Tornado Suburban L2 NAS-verified; Earthquake Suburban L1 corrected retry active from 10:51:45 UTC |
