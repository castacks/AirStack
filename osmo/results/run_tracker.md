...
GPU used about 20.35 GiB with Isaac and the detector active. All eight 600-s
...
NAS. L2 Frontier started next at **07:33:34 UTC**, passed all eight flight
gates and measured persistent-callback **RTF 0.17877** during search.
...
| L2 | Canonical frozen scene is published and passes a fresh Nucleus cold-open | Frontier active; then Lawnmower, VLFM, CoNavGPT2 + RayFronts | `urban_fire_remaining_8robot_optimized_pod58/2026-09-07_06-10-59` |
...
| 8c | `airstack-mission-1gpu-58` | Fire/Urban L1 Lawnmower + L2 four baselines | 1/5 | <12 h | RUNNING — L1 Lawnmower passed/uploaded/NAS-verified at team RTF **0.17612**; 4.43 GB MCAP present. L2 Frontier passed 8/8 flight gates and is searching at persistent RTF **0.17877**. Owned renderer/model GPU 2, original sensors/full contacts, pass-only immediate uploads, auto-launcher held |
...
| 10 | dev pod 191 | Hurricane/Urban L1 × Frontier, lawnmower, VLFM, CoNavGPT2 | 2/4 | ≤11 h | RUNNING — Frontier **passed** at bottleneck/team RTF **0.17664** (600.03 sim s / 3396.96 wall s) and Lawnmower **passed** at bottleneck/team RTF **0.15580** (600.03 sim s / 3851.17 wall s). Both passed 17/17 steps and are uploaded/NAS-verified under `hurricane_urban_l1_8robot_optimized_dev191/2026-09-07_04-58-24/` with nonempty MCAPs (4.11 GB Frontier, 4.53 GB Lawnmower). VLFM started at 07:41 UTC and is active. The launcher's storage env expanded an unquoted `$` in the password, so passed iterations are being manually uploaded with literal credential parsing and remote `iteration.json`/MCAP verification |
