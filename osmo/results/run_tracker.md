...
| 2-GPU 5 | Hurricane Suburban L3 RAVEN replacement attempt 2 started at **03:38:25 UTC** on renderer GPU 0 / offboard GPU 1 | Attempt 1 correctly failed the encoder gate because this stale pod lacked the offline SigLIP2 cache; it was not uploaded. The validated 4.58 GB cache was copied from pod 3 and its complete file/size manifest matches exactly. Attempt 2 uses commit `27ac448d`, 2× RTX PRO 5000 Blackwell, 300 s takeoff feedback, the 8/8 advancing-odometry gate, 8×600 s result gate, and checksum-verified upload/prune. Launcher PID 61 remains T. |
