...
gates and measured persistent-callback **RTF 0.21923**.
...
| L2 | Canonical frozen scene; Frontier baseline | VLFM active; Lawnmower rerun, CoNavGPT2 + RayFronts | `urban_fire_remaining_8robot_optimized_pod58/2026-09-07_06-10-59` |
...
| 8c | `airstack-mission-1gpu-58` | Fire/Urban L1 Lawnmower + L2 four baselines | 2/5 | <12 h | RUNNING — L1 Lawnmower and L2 Frontier passed/uploaded/NAS-verified at team RTFs **0.17612** and **0.19247**. L2 Lawnmower exhausted two tooling-failure attempts and was not uploaded; it needs a focused rerun. L2 VLFM passed 8/8 gates and is active at persistent RTF **0.21923**. Owned renderer/model GPU 2, original sensors/full contacts, pass-only immediate uploads, auto-launcher held |
