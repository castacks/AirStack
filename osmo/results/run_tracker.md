...
| 2-GPU 5 | Hurricane Suburban L3 and Tornado Suburban L2 RAVEN are **passed, uploaded, checksum-verified and locally pruned**; Earthquake Suburban L1 cold retry attempt 2/2 began at **11:15:44 UTC** under `raven_earthquakesuburbanl1v1_raven_remaining_2gpu1/2026-09-09_10-51-45` | Attempt 1 reached 7/8 takeoffs; robot 7 alone exhausted pre-arm state checks although its PX4 process remained alive. Teardown found and cleaned **2,235 orphan Fast DDS SHM segments** after a `fastrtps_port7119` lock error; the failed attempt was archived locally and not uploaded. Commit `95e8d7a4` raises the actual lane takeoff feedback watchdog to 900 seconds. Tornado L2 passed at whole-step **RTF 0.0446**, strict 10 m **0/40**, with only 51.2 m team motion. Launcher PID 61 remains T. |
...
| `airstack-mission-8robot-2gpu-5` | RAVEN lane B | RUNNING — Hurricane Suburban L3 and Tornado Suburban L2 NAS-verified; Earthquake Suburban L1 cold retry attempt 2/2 active from 11:15:44 UTC after orphan Fast DDS SHM cleanup |
