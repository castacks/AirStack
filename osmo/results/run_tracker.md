...
| 2-GPU 5 | Hurricane Suburban L3 and Tornado Suburban L2 RAVEN are **passed, uploaded, checksum-verified and locally pruned**; focused Earthquake Suburban L1 safety-synchronized rerun began at **11:43:15 UTC** under `raven_earthquakesuburbanl1v1_raven_remaining_2gpu1/2026-09-09_11-43-15` | The preceding cold retry reached 7/8 takeoffs; robot 4 had live odometry but the 1 Hz ROS safety timer still held `state_estimate_timed_out=true`, so three 10-wall-second retries all arrived before one low-RTF timer interval and were rejected. It was not uploaded. Commit `0479a97b` now requires a fresh safety `false` immediately before dispatch, without weakening the 8/8 takeoff gate. Tornado L2 passed at whole-step **RTF 0.0446**, strict 10 m **0/40**, with only 51.2 m team motion. Launcher PID 61 remains T. |
