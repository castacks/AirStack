...
| L2 | Canonical frozen scene; Frontier baseline | Lawnmower active; then VLFM, CoNavGPT2 + RayFronts | `urban_fire_remaining_8robot_optimized_pod58/2026-09-07_06-10-59` |
...
| 8c | `airstack-mission-1gpu-58` | Fire/Urban L1 Lawnmower + L2 four baselines | 2/5 | <12 h | RUNNING — L1 Lawnmower passed/uploaded/NAS-verified at team RTF **0.17612**; L2 Frontier passed/uploaded/NAS-verified at team RTF **0.19247**. L2 Lawnmower passed 8/8 flight gates and is searching at persistent RTF **0.20327**. Owned renderer/model GPU 2, original sensors/full contacts, pass-only immediate uploads, auto-launcher held |
...
| 10 | dev pod 191 | Hurricane/Urban L1 × Frontier, lawnmower, VLFM, CoNavGPT2 | 3/4 | ≤11 h | RUNNING — Frontier **passed** at bottleneck/team RTF **0.17664** (600.03 sim s / 3396.96 wall s), Lawnmower **passed** at **0.15580** (600.03 / 3851.17), and VLFM **passed** at **0.18885** (600.03 / 3177.28). All passed 17/17 steps and are uploaded/NAS-verified under `hurricane_urban_l1_8robot_optimized_dev191/2026-09-07_04-58-24/` with nonempty MCAPs (4.11 GB Frontier, 4.53 GB Lawnmower, 6.37 GB VLFM). CoNavGPT2 started at 08:53 UTC and is active. The launcher's storage env expanded an unquoted `$` in the password, so passed iterations are being manually uploaded with literal credential parsing and remote `iteration.json`/MCAP verification |
