...
class SemanticRayTransposer(Node):
    def __init__(self):
        super().__init__('robot_1_semantic_ray_transposer')
        ...
        self.subscription = self.create_subscription(
            MarkerArray,
            '/robot_1/filtered_rays',
            self.callback,
            10,
        )
        self.publisher = self.create_publisher(
            MarkerArray,
            '/robot_1/filtered_rays/transposed',
            10,
        )

        self.get_logger().info(
            f'Publishing transposed rays with translation '
    ...
    def callback(self, msg: MarkerArray):
        ...
        for marker in out.markers:
            ...
            # If marker uses per-point colors, force those to bright blue too.
