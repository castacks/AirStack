...
TrajectoryControlNode::TrajectoryControlNode() : BaseNode("trajectory_control_node") {}
    ...
    if (got_odom) {
        ...
        if (valid) {
            ...
            if (success) {
                ...
                core_trajectory_msgs::TrajectoryXYZVYaw segment_msg =
...
bool TrajectoryControlNode::set_trajectory_mode(
    core_trajectory_controller::TrajectoryMode::Request& req,
    core_trajectory_controller::TrajectoryMode::Response& res) {
