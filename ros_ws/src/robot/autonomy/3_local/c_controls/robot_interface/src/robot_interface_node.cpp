...
rclcpp::Subscription<mav_msgs::msg::RollPitchYawrateThrust>::SharedPtr roll_pitch_yawrate_thrust_sub;
...
int main(int argc, char** argv)
{
  ...
  try{
    ...
    // subscribers
    attitude_thrust_sub = ri->create_subscription<mav_msgs::msg::AttitudeThrust>("attitude_thrust_command", 1,
										 attitude_thrust_callback);
    rate_thrust_sub = ri->create_subscription<mav_msgs::msg::RateThrust>("rate_thrust_command", 1,
									 rate_thrust_callback);
    roll_pitch_yawrate_thrust_sub = ri->create_subscription<mav_msgs::msg::RollPitchYawrateThrust>("roll_pitch_yawrate_thrust_command",
												   1,
												   roll_pitch_yawrate_thrust_callback);
    torque_thrust_sub = ri->create_subscription<mav_msgs::msg::TorqueThrust>("torque_thrust_command", 1,
									     torque_thrust_callback);
    velocity_sub = ri->create_subscription<geometry_msgs::msg::TwistStamped>("velocity_command", 1,
									     velocity_callback);
