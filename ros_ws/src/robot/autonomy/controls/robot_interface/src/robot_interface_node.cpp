...
int main(int argc, char **argv)
{
  ...
  {
    rclcpp::Node::SharedPtr logger_node = rclcpp::Node::make_shared("robot_interface_node_logger");
    RCLCPP_ERROR(logger_node->get_logger(), "The plugin failed to load for some reason. Error: %s\n", ex.what());
    return 1;
  }
