 ...
 * @brief the Robot Interface specifies common MAV flight control functions for individual implementations to define.
 * @version 0.1
 * @date 2024-07-01
 *
...
{
  /**
   * @brief The Robot Interface class specifies common MAV flight control functions for individual implementations to define.
   *
   */
  ...
  public:
    ...
    // Command functions
    /**
     * @brief Call the service to request that the flight controller relinquish control 
