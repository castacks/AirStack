...
| [build-earthquake-scenes](.agents/skills/build-earthquake-scenes) | Earthquake damage to URBAN kit buildings — the interior fit-out, the per-construction-type ladder (masonry wall peel / corner / parapet / collapse, concrete soft storey / pancake, glass fallout, lean-and-sink), the archetype bake and the 250 m downtown assembly — and the bug catalogue (zero-thickness kit roofs, foil shells, machined hole edges) |
